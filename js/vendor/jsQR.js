 ...
 * 車検証の二次元コードは連結QR(Structured Append)なので、そのヘッダを読めるよう手を加えたもの。
 * 変更箇所は "[patched]" で検索 */
...
function decode(data, version) {
    ...
    while (stream.available() >= 4) {
        ...
        if (mode === ModeByte.Terminator) {
            ...
            // [patched] 連結(Structured Append)ヘッダ。元のjsQRは未対応で、以降のデータが崩れていた
            var sequence = stream.readBits(8);
            result.chunks.push({
                type: "structuredappend",
                currentSequence: sequence >> 4,
                totalSequence: (sequence & 15) + 1,
