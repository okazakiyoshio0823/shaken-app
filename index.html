...
<body>
    <div class="app-container">
        ...
        <div class="toolbar">
            ...
            <button type="button" class="btn btn-success" onclick="generatePDF()">📄 PDF出力</button>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="customerName" placeholder="山田 太郎">
                    </div>
                    <div class="form-group">
                        <label>フリガナ</label>
                        <input type="text" class="form-control" id="customerNameKana" placeholder="ヤマダ タロウ">
                    </div>
                </div>
                <div class="form-group">
                    <label>ご住所</label>
                    <input type="text" class="form-control" id="customerAddress" placeholder="〒000-0000 ○○県○○市...">
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>電話番号</label>
                        <input type="tel" class="form-control" id="customerTel" placeholder="000-0000-0000">
                    </div>
                    <div class="form-group">
                        <label>メールアドレス</label>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="plate-input">
                        ...
                        <input type="text" class="form-control" id="plateClass" placeholder="500">
                        <input type="text" class="form-control" id="plateHiragana" placeholder="あ">
                        <span>-</span>
                        <input type="text" class="form-control" id="plateSerial" placeholder="1234">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>初度登録年月</label>
                        <input type="month" class="form-control" id="firstRegistration">
                    </div>
                    <div class="form-group">
                        <label>走行距離</label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="add-item-row">
                    ...
                    <input type="number" class="form-control price" id="newItemPrice" placeholder="単価" min="0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <textarea class="form-control" id="notes" rows="3" placeholder="追加の整備が必要な場合は別途お見積りいたします。"></textarea>
            </div>
        </div>
    </div>
